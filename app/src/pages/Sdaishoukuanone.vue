...
export default {
  ...
  methods: {
    getInfo(pageSize, pageNo) {
      var _this = this;
      var params = "pageSize=" + pageSize + "&pageNo=" + pageNo + "&orderStatus=07&isSynchro=1&startTime="+this.message.startTime+"&endTime="+this.message.endTime+"&partnerKey="+this.message.partnerKey;
    ...
    //     <li class="active" @click="quitlist(2)">已对账</li>
    //     <li @click="quitlist(3)">草稿箱</li>
    //   </ul>
    // quitlist(num){

...
export default {
  ...
  methods: {
    getPeople(){
      this.axios.get(address.participation + localStorage.getItem('token') + "&oppoNo=" + this.$route.params.oppoNo)
       .then(data => {
    ...
    getInfo(page, rows) {
      this.axios.get(address.chatlist + localStorage.getItem('token') + "&oppoNo=" + this.$route.params.oppoNo + "&page=" + page + "&rows=" + rows)
        .then(data => {

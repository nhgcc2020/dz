  ...
  <div>
    ...
    <div class="big_first" style="padding-bottom:200px;">
        <ul class="big_one">
            ...
            <li @click="payment">付款方式<i class="iconfont">&#xe68b;</i><span>{{contacterName}}</span></li>
    ...
    <div class="but">
        <button @click="construction">{{foot}}</button>
    </div>
    <div class="general">
...
export default {
  ...
  created() {
    if(this.$route.params.salesNo=="日常账本"){
        this.accountType = "01";
        this.expenType = "0";
  ...
  methods: {
    ...
    var params = "&settingClass="+this.accountType;
    ...
    construction(){
        ...
        this.axios.post(address.insert + localStorage.getItem('token'),params)
        .then(function (data) {

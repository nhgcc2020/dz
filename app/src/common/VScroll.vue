    ...
    <div class="yo-scroll" :class="{'down':(state===0),'up':(state==1),refresh:(state===2),touch:touching}" @touchstart="touchStart($event)" @touchmove="touchMove($event)" @touchend="touchEnd($event)">
        <section class="inner" :style="{ transform: 'translate3d(0, ' + top + 'px, 0)' }">
            ...
            <footer class="load-more">
                <div name="load-more">
                    <!--<span v-show="downFlag === false">上拉加载更多weihejibudehsnagyici</span>-->
...
.yo-scroll {
    ...
    .inner {
        ...
        //     background: url(../assets/font-awesome/image/login.jpeg) no-repeat center;
        // }
        // .refresh-tip:before {
        //     background: url(../assets/font-awesome/image/login.jpeg) no-repeat center;
        // }
...
export default {
    ...
    methods: {
        ...
        touchEnd(e) {
            ...
            if (bottom <= this.offset && this.state === 0 && bottom>-10) {
                this.downFlag = true;
                this.infinite();
            } else {

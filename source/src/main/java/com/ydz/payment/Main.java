...
public class Main {
     ...
     */
    public static String apiKey = "sk_live_iDCyfPaL48O0L0ejLK1SCaf5";
    //sk_test_ibbTe5jLGCi5rzfH4OqPW9KC
    //sk_live_iDCyfPaL48O0L0ejLK1SCaf5

    /**
     * Pingpp 管理平台对应的应用 ID，app_id 获取方式：登录 [Dashboard](https://dashboard.pingxx.com)->点击你创建的应用->应用首页->应用 ID(App ID)
     */
    public static String appId = "app_KCqjj9anjv14COOy";
   ...
   */
    ...
    // 你生成的私钥路径
   /* public static String privateKeyFilePath = "/your_rsa_private_key.pem";*/

 ...
 *
 * 开发者需要填写 apiKey 和 appId  app_KCqjj9anjv14COOy，
 *
...
public class ChargeExample {
    ...
    public static Charge runDemos(String appId,String orderNo) {

        ChargeExample chargeExample = new ChargeExample(appId);
        System.out.println("------- 创建 charge -------");
         Charge charge = chargeExample.createCharge(orderNo);
        return charge;
     ...
     * @return Charge
     */
    public Charge createCharge(String orderNo) {
        Charge charge = null;
        ...
        //pxy
        //chargeMap.put("product_id", "");// 推荐使用 8-20 位，要求数字或字母，不允许其他字符

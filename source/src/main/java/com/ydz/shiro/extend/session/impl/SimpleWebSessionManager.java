package com.ydz.shiro.extend.session.impl;
...
/** 
 * @ClassName: SimpleWebSessionManager 
 * @Description: TODO(这里用一句话描述这个类的作用) 
 * @author Bruce 赵石磊 4stones@yiduizhang.com
 * @date 2016年9月3日 上午11:12:56 
 * 
 */
            ...
            for (Iterator<?> i$ = activeSessions.iterator(); i$.hasNext();) {  
                ...
                try {  
                    ...
                    if (cacheManager != null) {  
                        ...
                        if (s.getAttribute(com.ydz.util.Const.SESSION_USER) != null)  
                            cacheManager.getCache(null).remove(  
                                    s.getAttribute(com.ydz.util.Const.SESSION_USER));  
                    }  

...
public class ChangeCharset {
    ...
    public static String toASCII(String str) throws UnsupportedEncodingException {  
        return ChangeCharset.changeCharset(str, US_ASCII);  
    }  
    ...
    public static String toISO_8859_1(String str) throws UnsupportedEncodingException {  
        return ChangeCharset.changeCharset(str, ISO_8859_1);  
    }  
    ...
    public static String toUTF_8(String str) throws UnsupportedEncodingException {  
        return ChangeCharset.changeCharset(str, UTF_8);  
    }  
    ...
    public static String toUTF_16BE(String str) throws UnsupportedEncodingException {  
        return ChangeCharset.changeCharset(str, UTF_16BE);  
    }  
    ...
    public static String toUTF_16LE(String str) throws UnsupportedEncodingException {  
        return ChangeCharset.changeCharset(str, UTF_16LE);  
    }  
    ...
    public static String toUTF_16(String str) throws UnsupportedEncodingException {  
        return ChangeCharset.changeCharset(str, UTF_16);  
    }  
    ...
    public static String toGBK(String str) throws UnsupportedEncodingException {  
        return ChangeCharset.changeCharset(str, GBK);  
    }  

...
public class EncryptUtils {
	private String key = "yiduizhang.com";
    ...
    public String encryptDESByKey(String source){
    	String result = null;
    	try {
    		result = this.encryptToDES(this.getDESKey(this.encryptToSHA(encryptUtils.key)), source);
		} catch (Exception e) {
			e.printStackTrace();
		}
    	return result;
    ...
    public String decryptDESByKey(String source){
    	String result = null;
    	try {
    		result = this.decryptByDES(this.getDESKey(this.encryptToSHA(encryptUtils.key)), source);
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    	return result;
...
//        String source = "www.yiduizhang.com";
        String source = "1A-XG8798789456456-cc1c14cbde974294966bc08ee7a764e8";
        ...
        System.out.println("生成一个DES算法的密匙: "+key);
        ...
        System.out.println("生成一个AES算法的密匙: "+key1);
        ...
        try {
            String DESKey = encryptUtils.getDESKey(encryptUtils.encryptToSHA(encryptUtils.key));

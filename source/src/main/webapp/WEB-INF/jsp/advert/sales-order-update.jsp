<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <head>
        ...
        <script>
            ...
            arrclo_addList.push({
                ...
                formatter: function (value, row, index) {
                    return inputTemplateReq(value, index, 'requirements')
                }
            });
            arrclo_addList.push({
                field: 'length',
            ...
            arrclo_addList.push({
                ...
                width: 50,
                formatter: function (value, row, index) {
                    return inputTemplateUnit(value, row, 'unit')
                }
            });
            arrclo_addList.push({
                field: 'unitPrice',
        ...
        <script src="/resources/business/dzorder/sales-order/add.js?v=1b9139a5fd2429"></script>
        <script>
            function back(self) {
...
//                            parent.mainConfigUrl(config);
            ...
            //orderMoney payAmout rateNum rateAmount
        ...
        <script type="text/javascript" src="/resources/business/dzorder/sales-order/menu.js?v=ead41b66dc"></script>
    </head>

    <body>

        <div class="header">
            <img src="../../images/picture.png" alt="">修改销售单
        </div>
        ...
        <div class="row rowLb hide" style="margin-bottom: 20px;line-height: 30px;">
            <div class="form-group">
                <label class=" purchaseNameLb hide col-xs-1 control-label" style="width: 50px;padding-right:0;">客户 :</label>
                <div class=" purchaseNameLb hide col-xs-2" style="width:220px">
                    <select id="clientsDp" style="width:200px" >
            </select>
                </div>
                <label class=" purchaseNameLb hide col-xs-1 control-label" style="width: 50px;;padding-right:0;" class="">姓名 :</label>
                <div class="purchaseNameLb hide col-xs-2" style="width:160px">
                    <select id="contacterDp" style="width:140px">
            </select>
                </div>


                <label class="purchaseNoLb hide col-xs-1 control-label" style="width: 50px;padding-right:0;">客户 :</label>
                <div class="purchaseNoLb hide col-xs-2" style="width:220px">
                    <div style="width:200px" data-toggle="popover" data-placement="bottom" data-html="true" data-trigger="hover" class=" purchaseNoLb hide "
                        data-container="body" data-content="<div>这张订单为好友订单（即采购方有关联采购单），<br>无法更改客户信息</div>"><input readonly disabled class="form-control" type="text" id="partnerShortnameText"></div>
                </div>

                <label class="purchaseNoLb hide col-xs-1 control-label" style="width: 50px;;padding-right:0;">姓名 :</label>
                <div class="purchaseNoLb hide col-xs-2" style="width:160px">
                    <div data-toggle="popover" data-placement="bottom" data-html="true" style="width:140px" data-container="body" data-trigger="hover"
                        data-content="<div>这张订单为好友订单（即采购方有关联采购单），<br>无法更改客户信息</div>"><input readonly disabled id="contactNameText" class="form-control" type="text" placeholder=""></div>
                </div>
        ...
        <div class="row" style="line-height: 30px;">
            ...
            <div class="col-xs-6" style="padding-left: 5px;">
                <%--<span  class="iconfont_new" style="position: relative;top:-1px;vertical-align: middle;font-size: 20px">&#xe6b8;</span>--%>
                    <%--<label style="width: 70px;padding-right:0;" class="">启用派工 :</label>--%>
                        <%--<div class="checkbox checkbox-slider--b-flat " style="display: inline-block;margin-top: 6px;padding-left: 5px;margin-left:-20px;"><label><input class="onPaiGong"  value="1"  type="checkbox"><span></span></label></div>--%>
                            <%--<div class="iconfont_new" style="color: #ff9900;display:inline-block;font-size:25px;position: relative;top:5px;left:-5px;"id="caozuoTip"  data-toggle="popover" data-container="body" data-trigger="hover" data-placement="bottom"--%>
                                <%--data-html="true"        data-content="默认启用派工功能，可以在派工/制作派工看到相关订单的工作进度，制作工也会看到相应的任务，制作进度会实时同步给协同方。" >&#xe6b8;</div>--%>
                                    ...
                                    <div class="iconfont_new hide onPaiGongLabel" style="color: #ff9900;display:inline-block;font-size:25px;position: relative;top:5px;left:-5px;"
                                        data-toggle="popover" data-container="body" data-trigger="hover" data-placement="bottom"
                                        data-html="true" data-content="如果不需要制作派工<br>可在派工--制作--工序配置页顶部，把启用默认制作派工关闭">&#xe6b8;</div>
                                    ...
                                    <div class="iconfont_new hide onPaiGongDesignLabel" style="color: #ff9900;display:inline-block;font-size:25px;position: relative;top:5px;left:-5px;"
                                        data-toggle="popover" data-container="body" data-trigger="hover" data-placement="bottom"
                                        data-html="true" data-content="如不需要设计派工<br>可在派工--设计--任务分派页，把启用默认设计派工关闭">&#xe6b8;</div>
                                    ...
                                    <div class="iconfont_new" style="color: #ff9900;display:inline-block;font-size:25px;position: relative;top:5px;left:-3px;"
                                        data-toggle="popover" data-container="body" data-trigger="hover" data-placement="bottom"
                                        data-html="true" data-content="选择整单加急<br>派工所有任务处于优先制作状态，制作工会优先制作这张订单">&#xe6b8;</div>
            </div>
...
fitColumns : true,
        ...
        <div id="bottomBox">
            <div class="h-box" style="height:204px;">
                    ...
                    <div class="v-box">
                        <div class="flex-box">
                            <div class="remark-container">
                                ...
                                <textarea placeholder="备注……" id="remarkInput" class="form-control" style="max-width:669px;height: 60px;display:none;border-color:#d7d7d7;"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="box right-summary" style="width:300px;">
                    ...
                    <div class="h-box sales-box">
                        ...
                        <div class="flex-box">
                            <div>
                                ...
                                <div class="moneyInput ui input icon" style="width: 80px;"><input id="salesCount" maxlength="4" value="0" onkeyup="priceCountTwo()" type="text"><i class="percent icon"></i></div>
                            </div>
                        </div>
                    ...
                    <div style="height: 35px;" class="h-box minus-box">
                ...
                <div class="box">
                    <div class="btnGrp ui segment basic">
                        ...
                        <div id="status01_btn_group" style="display: none">
                            ...
                            <button type="button" style="width:104px; border-color:#d7d7d7;color:#999;" onclick="saveDraft(this)" id="draftBtnTw" class="btn btn-info">保存至草稿箱</button>
                            <button type="button" style="width:118px;margin-left:7px;" id="saveCashPg" onclick="ifSaveCash(this)" class="btn  btn-warning">创建订单并收款</button>
                            <button type="button" style="width:100px;" userdata="1" onclick="saveAll(this)" class="btn btn-primary">创建订单</button>
                        </div>
                        <div id="status04_btn_group" style="display: none;">
                            <div style="width: 35px; display:inline-block; cursor: pointer;color:#999;" onclick="back(this)">取消</div>
                            <button type="button" style="width:104px; border-color:#d7d7d7;color:#999;" onclick="saveDraft(this)" id="draftBtnText" class="hide btn btn-info">保存至草稿箱</button>
                            <button type="button" style="width:100px;" userdata="1" onclick="saveAll(this)" class="btn btn-primary">保存订单</button>
                        </div>
        ...
        <div id="topBar" class="topbarCss">
            <div style="width: 1100px;margin: 0 auto">
                ...
                <div style="margin:0 auto;position:relative;">
                    <div id="file_div" style="margin-top: 2rem;display: inline-block; font-size: 14px;">
    ...
    float: right;
    font-size: 14px;
    margin: 23px 20px 23px 0;">上传文件数 <span style="color:#ccc;font-size:18px;margin-left:50px;">&nbsp;0</span></span>
                        <!--<button>上传</button>-->
    ...
    line-height: 150px;"></div>
        ...
        <div id="topBarPR" class="topbarPrCss" style="height: 700px">
            <%--这个是加载框，切勿修改--%>
    ...
    color: #b3b3b3;">&#xe6df;</span>
                    ...
                    <div class="conTbText">
                        <table id="order" style=" width: 100%;margin-top:50px;height: 600px;" class="easyui-datagrid " data-options="remoteSort:false,
fitColumns : true,
           nowrap:true,singleSelect:true,checkOnSelect:false,
...
">
        ...
        <div class="animated flipInY" id="createOrderPop">
            ...
            取消
                    ...
                    <button type="button" style="margin-left:15px;width: 100px" class="btn btn-primary" onclick="saveCash(this)">创建
        </button>
                </div>
        </div>

            ...
            <div class=" row" style="margin:0;">
                ...
                <div class="col-xs-2" style="width:200px;">
                    ...
                    <input type="text" style="" did="" class="form-control ydz_select2" readonly name="mediaNo"
                           placeholder="媒体资源"/><span class="ydz_select_a"></span>
                </div>
                <div class="col-xs-2" style="width:250px;">
                    <input type="text" style="" did="1"  id="citySelDt" class="form-control ydz_input_readOnly city" readonly name=""
                ...
                <button type="button" class="btn btn-primary pull-right receivableBtn "
                        ...
                        onclick="oppColumnFun.openReceivablesBar()">新建点位
                </button>
                <button type="button" class="btn btn-warning pull-right receivableBtn "
                        style="margin-right:15px;height:30px;line-height:1;"
                        onclick="oppColumnFun.modifyWin()">修改点位状态
                </button>
            </div>
        </form>
    </div>
...
//            $("#autoEditOnceWin").draggable({ cursor: "move", containment: "parent"});
        ...
        window.oppColumnFun = {
            ...
            openReceivablesBar: function () {
                var turl = "/openPage?pageName=media_media-point-add";
...
//            $("input[name='recpayName']").val("");
        ...
        function oppColumn() {
            ...
            arrclo.push({field: '5', width: 90, align: 'center', title: '点位排期',  formatter: function (value, row) {
                var md=row.pointNo;
                    return  '<a style="cursor: pointer" onclick="lookSchedule(\''+md+'\')">查看排期</a>';
            }});
            arrclo.push({field: 'pointLocation', width: 150, align: 'center', title: '位置'});
//            arrclo.push({field: '7', width: 90, align: 'center', title: '实景'});
            ...
            arrclo.push({field: 'btn', width: 110, align: 'center', title: '操作',
                formatter: function (value, row) {
                var md=row.pointNo;
                var   changeItem = JSON.stringify(row);
                    return "<a style='cursor: pointer' onclick='modifyPoint("+changeItem+")'>修改</a><a style='cursor: pointer;margin-left:15px;' onclick='openProReq("+changeItem+")'>管理实景</a>";
                }});
        ...
        window.lookSchedule=function(p) {
            window.location.href="/ydz/mediaresource/forward-media-point-period?pointNo="+p+"&type=point";

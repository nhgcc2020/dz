...
>
    ...
    <div class="fixheader">
        ...
        <%--</button>--%>
        <button type="button"  onclick="backList(this)" class="btn  cancelOpp"
...
<script type="text/javascript">
    ...
    function init(){
        ...
        window.webuploader = {
            ...
            formData:{pointNo: "${pointNo}"},
            //处理客户端新文件上传时，需要调用后台处理的地址, 必填
            uploadUrl: '/ydz/mediaresource/fileUpload',
            //处理客户端原有文件更新时的后台处理地址，必填
            updateUrl: '',
            //当客户端原有文件删除时的后台处理地址，必填
            removeUrl: '/ydz/mediaresource/deletefile',
            //初始化客户端上传文件，从后台获取文件的地址, 可选，当此参数为空时，默认已上传的文件为空
            initUrl: '/ydz/mediaresource/listPictureFile?pointNo=${pointNo}',
        }

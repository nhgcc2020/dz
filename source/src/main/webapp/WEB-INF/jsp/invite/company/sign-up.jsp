...
<div class="shark_contant">
    ...
    <div class="mui-content" style="background: transparent;">
        <div class="mui-content-padded related_form_content">
            ...
            <form id="signForm" class="mui-input-group related_form">
                ...
                <%--邀请企业时没有真实姓名--%>
                <div class="mui-input-row related_form_row">
                    <input type="text" class="mui-input-clear" id="realName" name="realName" value="${company.partnerName}" placeholder="请输入真实姓名">
                </div>
                <div class="mui-input-row related_form_row">
                ...
                <div class="related_form_check related_form_prov_undline">
    ...
    <%--<div class="button-copyright" style="margin-top: 170px; color: #fff;">上海仁石科技有限公司欢迎您注册使用易对账!</br>Copyright@2016 沪 ICP备16005067</div>--%>
</div>
<script>
    //同意选中监听
    ...
    $("#next_tap").click(function(self){
        ...
        $.post("<c:url value="/invite/com/signUp"/>",$("#signForm").serialize(),function(callback){

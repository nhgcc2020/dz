    ...
    <div class="mui-content-padded related_form_content">
        <form id="create_con" class="mui-input-group related_form">
            ...
            <div class="mui-segmented-control">
                <a class="mui-control-item mui-active" href="#item1" data-value="boss" style="text-decoration: none;">法人代表管理员</a>
                <a class="mui-control-item" href="#item2"   data-value="admin" style="text-decoration: none;">管理员</a>
            </div>
...
<script>
    ...
    $("#next_tap").click(function(){
        ...
        if(comName != "" && comShortname != "" && comProvince.value != "" && comCity.value != "" && comCountry.value != ""){
            ...
            $.post( "/invite/normal/saveCom",
                    $("#create_con").serialize(),
                    function (callback) {
                        var data =  eval("("+callback+")");
                        if(data=="1"){
                            window.location.href="<c:url value="/invite/normal/create_succ"/>";
                        }else{

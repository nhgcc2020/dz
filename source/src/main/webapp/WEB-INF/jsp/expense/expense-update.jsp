...
<script>
    ...
    var listurl = "/ydz/expensebook/selectOneExpenseBook?expenseType=0&&expenseNo=" + expenseNo;
    var numberArr = [];
    var atter;
    ...
    function changeClients(list) {
        if (type == "update") {
            ...
            pageSaveOrderConUrl = "/ydz/expensebook/update?expenseType=1";
        } else {
            $(".new_header").text("新建费用")
            $(".btn-primary").text("创建")
            $("#orderDate").val(new Date().Format("yyyy-MM-dd"));
            pageSaveOrderConUrl = "/ydz/expensebook/insert?expenseType=1";
        }

       ...
       model.describe("tags", {
        ...
        createTable = function (definition) {
            var $inputTemplate, businessDescTemplate, column, columns, config, container, context, j, len1, operationTemplate, ref, table, urgentBtn, $selectTemplate,
                $requireTemplate, $valuationTemplate;
            columns = [];
...
//                    model.action("saveCash")(self);
            ...
            saveDraft: function (self, arg) {
                ...
                $.ajax({
                    url: "/ydz/purchaseOrder/updateAsDraft",
                    type: "post",
                    data: JSON.stringify(saveData),
                    dataType: "json",
                    contentType: "application/json",
                    success: function (callBack) {
                        if (callBack.status == '1') {
                            ...
                            var config = {
                                ...
                                icon: "icon dashboard",
                                label: "销售订单管理",
                                path: "/openPage?pageName=advert_sales-order-list&type=" + type,
                                type: "subWindow"
                            };
